...
abstract class WriteAppStreamFile : DefaultTask() {
    ...
    fun run() {
        ...
        comp.appendChild(doc.createElement("id", "com.credgen.credgen"))
        ...
        comp.appendChild(makeURL(doc, "bugtracker", "https://github.com/LoadingByte/credgen/issues"))
        comp.appendChild(makeURL(doc, "help", "https://credgen.com/guide/"))
        comp.appendChild(makeURL(doc, "donation", "https://credgen.com/donate/"))
        comp.appendChild(makeURL(doc, "translate", "https://hosted.weblate.org/projects/credgen/"))
        comp.appendChild(makeURL(doc, "vcs-browser", "https://github.com/LoadingByte/credgen"))
        comp.appendChild(doc.createElement("launchable", "credgen.desktop").apply {
        ...
        comp.appendChild(doc.createElement("screenshots").apply {
            ...
            appendChild(doc.createElement("screenshot").apply {
                appendChild(doc.createElement("image", "https://credgen.com/assets/credits-media.png"))
            })
        })
    ...
    private fun makeLocalizedScreenshot(doc: Document, name: String): Element {
        ...
        for (locale in slogans.get().keys) {
            val url = "https://credgen.com/assets/$name.${locale.toLanguageTag()}.png"
