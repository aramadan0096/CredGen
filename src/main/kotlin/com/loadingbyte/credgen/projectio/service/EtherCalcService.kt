package com.loadingbyte.credgen.projectio.service

import com.loadingbyte.credgen.common.*
import com.loadingbyte.credgen.projectio.CsvFormat
import com.loadingbyte.credgen.projectio.Spreadsheet
import com.loadingbyte.credgen.projectio.SpreadsheetLook
...
object EtherCalcService : Service {
    ...
    private fun httpRequestBuilder(uri: URI) = HttpRequest.newBuilder(uri).setHeader("User-Agent", "CredGen/$VERSION")
