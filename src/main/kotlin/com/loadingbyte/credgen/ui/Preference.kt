...
val DECK_LINK_PRI_PREFERENCE: Preference<Int> = IntPreference("deckLinkPrimaries", ColorSpace.Primaries.BT709.code)
...
private object PreferencesToml {
    ...
    init {
        ...
        if (!exists()) {
            ...
            if (legacyRoot.nodeExists("com/loadingbyte/credgen")) {
                toml[SET_UP_PREFERENCE.key] = true
                val legacyPrefs = legacyRoot.node("com/loadingbyte/credgen")
