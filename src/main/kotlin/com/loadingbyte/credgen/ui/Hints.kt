...
import com.loadingbyte.credgen.common.l10nQuoted
import com.loadingbyte.credgen.ui.comms.ProjectsCard
import com.loadingbyte.credgen.ui.comms.WelcomeTab
import com.loadingbyte.credgen.ui.helper.withNewG2
...
fun makeProjectHintTrack(ctrl: ProjectController): HintTrack {
    ...
    return listOf(
        ...
        Hint(l10n("ui.hints.projectTrack.finished", "<i>credgen.com</i>"), editPanel, Side.NONE)
    )
}
