...
import com.loadingbyte.credgen.ui.UIFactory
import com.loadingbyte.credgen.ui.UI_LOCALE_PREFERENCE
import com.loadingbyte.credgen.ui.comms.MasterCtrlComms
import com.loadingbyte.credgen.ui.comms.WelcomeTab
...
private const val SINGLETON_APP_ID = "com.loadingbyte.credgen"
...
private fun mainSwing(args: Array<String>) {
    ...
    // Notice that we could also set it to "credgen" (in lower case) as Gnome would then find the matching
    // credgen.desktop file and extract the app name from there, but directly setting the app name seems more portable.
...
"""
    ...
    private fun sendReport(header: String) {
        ...
        if (send) {
            val address = encodeMailURIComponent("crashes@credgen.com")
