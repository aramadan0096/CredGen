...
import com.loadingbyte.credgen.common.Timecode
import com.loadingbyte.credgen.common.l10n
import com.loadingbyte.credgen.common.useResourcePath
import com.loadingbyte.credgen.demo.*
...
object GuidePictureVideoAutoAddDemo : ScreencastDemo(
    ...
    override fun generate() {
        ...
        addProjectWindows(hideStyWin = true, prepareProjectDir = {
            ...
            logosDir.resolve("credgen H.svg").moveTo(logosDir.resolve("credgen.svg"))
        })
        ...
        sc.hold(2 * hold)
        sc.type(spreadsheetEditorWin, 6, 1, "{{${l10n("projectIO.credits.table.pic")} credgen}}", 8 * hold)
        sc.mouseTo(prjWin.desktopPosOf(prjPnl.leakedStylingDialogButton))
        sc.click(4 * hold)
        sc.mouseTo(styWin.desktopPosOfTreeItem(styTree, "credgen"))
        sc.click(12 * hold)
        sc.mouseTo(prjWin.desktopPosOf(prjPnl.leakedStylingDialogButton))
        sc.click()
        sc.type(spreadsheetEditorWin, 6, 1, "{{${l10n("projectIO.credits.table.pic")} credgen.svg}}")
        sc.mouseTo(prjWin.desktopPosOf(prjPnl.leakedStylingDialogButton))
        sc.click(8 * hold)
        sc.click()
        sc.type(spreadsheetEditorWin, 6, 1, "{{${l10n("projectIO.credits.table.pic")} credgen Cropped}}")
        sc.mouseTo(prjWin.desktopPosOf(prjPnl.leakedStylingDialogButton))
        sc.click()
        sc.mouseTo(styWin.desktopPosOfTreeItem(styTree, "credgen Cropped"))
        sc.click()
...
object GuidePictureVideoPictureNameDemo : StyleSettingsDemo<PictureStyle>(
    ...
    override fun styles() = buildList<PictureStyle> {
        this += PRESET_PICTURE_STYLE.copy(name = "credgen Cropped")
    }
}
...
object GuidePictureVideoPictureFileDemo : StyleSettingsDemo<PictureStyle>(
    ...
    override val pictureLoaders by lazy {
        ...
        val picFile = tmpDir.resolve("credgen.svg")
